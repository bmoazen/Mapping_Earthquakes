...
let recentQuakes = new L.LayerGroup();

// 2. Add a reference to the major earthquake group to the overlays object.
let overlays = {
  "Earthquakes (7 Days)": allEarthquakes,
  "Major Earthquakes (7 Days)": majorQuakes,
  "Earthquakes (Last Hour)": recentQuakes,
...
// 3. Retrieve the earthquake data from the last hour.
let recentData="https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_hour.geojson";
d3.json(recentData).then(function(data) {
